...
- **部署核对**：构建产物与部署 jar **逐字节相同**
  （1,798,454 B / md5 `1A90977DEFF0D3192342EB4C4BADD21C` / 122 条目）。
...
| 0.0.20 | `goetytuner-0.0.20.jar` | 1,798,454 B | `1A90977DEFF0D3192342EB4C4BADD21C` | `versions\测试\mods\`（该目录只保留这一个 goetytuner jar） |
