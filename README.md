...
- `client/` 音乐播放器 `BossMusicManager`、节奏条 HUD、配置界面 + Toast、相机震颤、`ClientDeathAnimation`（死亡动画复位）、`AccentWaveRenderer`（世界空间声波涟漪，`RenderLevelStageEvent.Stage.AFTER_PARTICLES`）
